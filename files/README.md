...
### What's included
- Live scorepad with your custom Gin rules, leagues, leaderboards and past-game history.
- **Accounts** (sign in / sign up / guest), with a password-reset flow.
- **Cloud sync** of rules, saved players, leagues and games; league games shared with members.
- **Import device games** into your account after signing in.
- **Installable app** (Add to Home Screen / Install) — works offline once loaded.
- **Share** standings and individual results via your phone's share sheet.
- **Backup**: export all your data to a file, and restore it (guest mode).

You only need to do the steps below once. Budget ~15 minutes.
